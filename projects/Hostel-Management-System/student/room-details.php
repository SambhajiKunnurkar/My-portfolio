        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                <form action="process.php" method="post">
                    <label for="response">Will you  attend today?</label><br>
                    <input type="radio" id="yes" name="response" value="yes" checked>
                            ...
                            <div class="table-responsive">
                                <table id="zctb" class="table table-striped table-bordered no-wrap">
                                    <tbody>
                                        ...
                                        <!-- <tr>
                                            <td><b>Yes Counter:</b></td>
                                            <td colspan="6"><?php echo $row->yes_counter;?></td>
                                        </tr> -->
                                        <?php
                                        $cnt=$cnt+1;
                                        } ?>
