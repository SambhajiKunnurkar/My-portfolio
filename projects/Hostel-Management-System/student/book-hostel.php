                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="customRadio1">Required only breakfast <code>Extra 1500 Per Month</code></label>
                                </div><div class="custom-control custom-radio">
                                    <input type="radio" id="customRadio3" value="2" name="foodstatus"
                                        class="custom-control-input">
                                    <label class="custom-control-label" for="customRadio3">Required breakfast and dinner <code>Extra 2000 Per Month</code></label>
                                </div><div class="custom-control custom-radio">
                                    <input type="radio" id="customRadio4" value="3" name="foodstatus"
                                        class="custom-control-input">
                                    <label class="custom-control-label" for="customRadio4">Required full <code>Extra 3000 Per Month</code></label>
                                </div>
                                <div class="custom-control custom-radio">
