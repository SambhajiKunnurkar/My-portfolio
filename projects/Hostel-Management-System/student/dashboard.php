<?php
    ...
    (COUNT(*) / (SELECT COUNT(*) FROM registration WHERE feedback IS NOT NULL AND feedback != '')) * 100 AS percentage 
    FROM registration 
    WHERE feedback IS NOT NULL AND feedback != '' 
    GROUP BY feedback 
    ORDER BY count DESC 
    LIMIT 1";
$feedback_stmt = $mysqli->prepare($feedback_query);
$feedback_stmt->execute();
$feedback_result = $feedback_stmt->get_result();
$feedback_row = $feedback_result->fetch_assoc();
$common_feedback = $feedback_row['feedback'];
$feedback_percentage = $feedback_row['percentage'];
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card-group">
                    ...
                    <!-- <?php if ($feedback_percentage >= 60): ?>
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 font-weight-medium">Acknowledgement</h2>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Your feedback approved <?php echo $common_feedback; ?> as the request is more than (<?php echo round($feedback_percentage, 2); ?>%)</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
            ...
            <div class="d-flex d-lg-flex d-md-block align-items-center">
                <div>
                    ...
                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">
                        The dish changed to <?php echo $common_feedback; ?> as the request is more than (<?php echo round($feedback_percentage, 2); ?>%)
                    </h6>
                </div>
                <div class="ml-auto mt-md-3 mt-lg-0">
                    <span class="opacity-7 text-muted"><i data-feather="check-circle"></i></span>
        ...
        <div class="card-body">
            <div class="d-flex d-lg-flex d-md-block align-items-center">
                <div>
                    <h2 class="text-dark mb-1 font-weight-medium">Acknowledgement</h2>
                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">
                        The dish remains unchanged as the request is less than (<?php echo round($feedback_percentage, 2); ?>%)
                    </h6>
                </div>
                <div class="ml-auto mt-md-3 mt-lg-0">
