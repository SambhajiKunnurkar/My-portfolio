            ...
            <div class="banner-bottom">
                    ...
                    <div class="banner_bottom_agile_grids">
                        <div class="row wthree_banner_bottom_right_grids pr-sm-3">
                            ...
                            <div class="col-lg-3 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
                                <div class="view view1 view-tenth" border="5px">
                                    <div class="agile_text_box">
                                        <i class="fas fa-bed" aria-hidden="true"></i>
                                        <h3>Apply for Mess</h3>
                                        <p>BreakFast </p>
                                        <h3>RS 1500</h3>
                                        <!-- <h3><a href="menu1.php">see menu</a></h3>s -->
                                    </div>
                                    <div class="mask">
                            ...
                            <div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
                                <div class="view view2 view-tenth">
                                    <div class="agile_text_box">
                                        ...
                                        <h3>RS 2000</h3>
                                        <!-- <h3><a href="menu2.php">see menu</a></h3> -->
                                    </div>
                                    <div class="mask">
                            ...
                            <div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
                                <div class="view view3 view-tenth">
                                    <div class="agile_text_box">
                                        ...
                                        <h3>RS 3000</h3>
                                        <!-- <h3><a href="menu3.php">see menu</a></h3> -->
                                    </div>
                                    <div class="mask">
                ...
                <div class="table-responsive">
                    ...
                    <thead class="thead-dark">
                        ...
                        <!-- <td><a href="edit-menu.php?id=<?php echo $row->id;?>" title="Edit"><i class="icon-note"></i></a>&nbsp;&nbsp;
                        <a href="manage-menu.php?del=<?php echo $row->id;?>" title="Delete" onclick="return confirm("Do you want to delete");"><i class="icon-close" style="color:red;"></i></a></td> -->
                        </tr>
                            <?php
                                $cnt=$cnt+1;
                            } ?>
